...
public class JSONObject extends LinkedHashMap<String, Object> {
    ...
    /**
     * 将对象转为Integer类型
     * 支持Integer、Number、String、Boolean
     *
     * @param value
     * @return
     */
    ...
    /**
     * 将对象转为Boolean
     * 支持Boolean、Number类型、"true"/"false"字符串类型
     *
     * @param value
     * @return
     */
     ...
     * 将是Collection类型同时又不是MessageArray的类型，转换为MessageArray的类型
     *
     * @param value 值。
     * @return 返回转换后的值。
     */
    ...
    /**
     * 处理多维数组的工具函数（包括一维数组）。多维数组的名字如：array[1][2][3]， 则name=array，indexStr=[1][2][3]，在callback中，endArr将是
     * array[1][2]指定的对象，index=3。
     *
